  ...
  return (
    <section id="cta" className="py-24 md:py-36 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/15 rounded-full blur-[100px]"></div>
        <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-blue-500/10 rounded-full blur-[80px] animate-blob"></div>
        <div className="absolute top-1/2 right-1/3 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-indigo-500/10 rounded-full blur-[80px] animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          >
            {["500+ scuole", "12.000+ rappresentanti", "300+ template", "Gratis per sempre"].map(
              (badge, i) => (
